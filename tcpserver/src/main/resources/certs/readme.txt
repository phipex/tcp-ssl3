...
c:>keytool -export -keystore serverkey.jks -alias serverKey -file ServerPublicKey.cer

Para meter la clave publica del servidor en los certificados de confianza del cliente.

c:>keytool -import -v -trustcacerts -alias serverKey -file ServerPublicKey.cer -keystore clientTrustedCerts.jks -keypass clientpass -storepass clientpass
